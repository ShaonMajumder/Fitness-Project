...
User_Profile_Frame = tkinter.Frame(Life_Frame, bg = 'red', relief=tkinter.RAISED, borderwidth=1)
User_Profile_Frame_Label = tkinter.Label(User_Profile_Frame, text = "User Profile Section")
Gender_Label = tkinter.Label(User_Profile_Frame, text = "Gender")
Fitness_Goal_Label = tkinter.Label(User_Profile_Frame, text = "Fitness Goal")
...
Age_Label = tkinter.Label(User_Profile_Frame, text = "Age")
Height_Label = tkinter.Label(User_Profile_Frame, text = "Height")
Goal_Body_Fat_Percentage_Label = tkinter.Label(User_Profile_Frame, text = "Goal Body Fat Percentage")
Bodyweight_Label = tkinter.Label(User_Profile_Frame, text = "Todays Bodyweight")
Body_Fat_Percentage_Label = tkinter.Label(User_Profile_Frame, text = "Todays Body Fat Percentage")
Blood_Pressure_Label = tkinter.Label(User_Profile_Frame, text = "Todays Blood Pressure")
...
Sleep_Section_Button = tkinter.Button(Sleep_Section_Frame, text="Submit", command=sleep_add_form)
